...
## Solution
The game is implemented using Python programming language. The solution involves capturing user inputs, generating a random move for the computer player, and comparing the moves to determine the winner. The project utilizes basic programming concepts and conditional statements to implement the game logic.
...
## Source Code
You can find the source code of the project on https://github.com/stefipop/Rock-Paper-Scissors_by_Stefi.
